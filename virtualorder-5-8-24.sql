...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2024 a las 22:38:20
...
INSERT INTO `articulos` (`CARTICULO`, `NOMBRE`, `DESCRIPCION`, `CMARCA`, `CRUBRO`, `CTIPO`, `VIGENTE`, `PRECIO_UNIT`, `IMG_PATH`, `FALTA`, `FMODI`) VALUES
(0, 'VARIOS', 'VARIOS', '1', 1, 2, 1, '1', 'NULL', '', ''),
...
(31, 'Gaseosa Coca Cola', 'Coca Cola', '1', 2, 1, 1, '2100', 'static/img/articles\\31.jpg', '', ''),
(32, 'Gaseosa Sprite', 'Sprite', '1', 2, 1, 1, '2100', 'static/img/articles\\32.jpg', '', ''),
(33, 'Energizante Speed', 'Speed', '1', 2, 1, 0, '2100', 'speed.jpg', '', ''),
...
(38, 8, 1, 0, 0, '2024-08-02 15:46:52', 1),
...
INSERT INTO `ordenes_det` (`CDETALLE_ORDEN`, `CORDEN`, `CARTICULO`, `CANTIDAD`, `ESTADO_DETALLE`, `PRECIO_ORDEN`, `GENERADO_POR`) VALUES
(3, 7, 16, 1, 1, 3000, 0),
(4, 7, 20, 1, 1, 3050, 0),
(5, 7, 15, 2, 1, 3000, 0),
(6, 7, 19, 2, 1, 5000, 0),
...
(57, 23, 16, 2, 1, 6000, 0),
(58, 24, 18, 1, 1, 2300, 0),
(59, 25, 19, 6, 1, 15000, 0),
(61, 28, 30, 5, 1, 10000, 0),
(62, 29, 25, 6, 1, 4200, 0),
(63, 30, 18, 2, 1, 4600, 0),
(64, 30, 15, 2, 1, 3360, 0),
(70, 33, 15, 1, 1, 1680, 0),
(71, 33, 24, 6, 1, 12000, 0),
(72, 34, 23, 2, 1, 3000, 0),
(73, 34, 15, 2, 1, 3360, 0),
(74, 34, 16, 2, 1, 6000, 0),
(75, 35, 35, 1, 1, 9000, 0),
...
--
ALTER TABLE `ordenes_det`
  MODIFY `CDETALLE_ORDEN` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
