...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-02-2024 a las 15:48:58
...
INSERT INTO `order_det` (`id_detail`, `id_order`, `id_article`, `amount`, `order_price`) VALUES
(3, 7, 16, 1, 3000),
(4, 7, 20, 1, 3050),
(5, 7, 15, 2, 3000),
(6, 7, 19, 2, 5000),
...
--
ALTER TABLE `articles`
  MODIFY `id_article` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de la tabla `order`
--
ALTER TABLE `order`
  MODIFY `id_order` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `order_det`
--
ALTER TABLE `order_det`
  MODIFY `id_detail` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `qr`
--
ALTER TABLE `qr`
  MODIFY `id_qr` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
