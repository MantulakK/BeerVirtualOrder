...
def mobile_cart():
    ...
    try:
        ...
        cursor = db.database.cursor(dictionary=True)  # Establecer dictionary=True para obtener resultados como diccionarios
        ...
        id_table = result['id_table']  # Acceder al valor utilizando el nombre de la columna
